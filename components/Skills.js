  ...
  return (
    <div id="skills" className="w-full lg:h-screen pt-24">
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
        ...
        {/* Technical skills */}
        <p className="py-4 text-xl tracking-widest uppercase text-[#1A5276]">TECHNICAL SKILLS</p>
        ...
        {/* Tools section */}
        <p className="py-4 text-xl tracking-widest uppercase text-[#1A5276]">TOOLS</p>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
